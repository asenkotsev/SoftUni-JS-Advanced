function solveClasses() {
    ...
    class Cat extends Pet {
        ...
        toString() {
            const result = [super.toString(), 'Main information:'];
            if (this.scratching) {
    ...
    class Dog extends Pet {
        ...
        toString() {
            const result = [super.toString(), 'Main information:', `${this.name} is a dog with need of ${this.runningNeeds}km running every day and ${this.trainability} trainability.`];
            return result.join('\n');
        }
    }
